...
#define WHO_AM_I         0x75  // si es igual a 0x71, es MPU9250; si es 0x73, es MPU9255; si es 0x70, es MPU6500
...
/* ---------------------------- PROGRAM STARTS ------------------------------- */
#define   MAG_MODE_MASK       ob11110000  //Register 0xA [3:0 bit]
#define   MAG_MODE_1          0x02 //Nuevo en Rpi (ODR = 8 Hz)
#define   MAG_MODE_2          0x06 //(ODR = 100 Hz)
